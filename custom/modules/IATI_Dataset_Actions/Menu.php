...
if (ACLController::checkAccess('IATI_Dataset_Actions', 'edit', true)) {
    $module_menu[] = array('index.php?module=IATI_Dataset_Actions&action=EditView&return_module=IATI_Dataset_Actions&return_action=DetailView', $mod_strings['LNK_NEW_RECORD'], 'Add', 'IATI_Dataset_Actions');
}
